...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Wine wine1 = new Wine("CVS Chardonnay", fingerLakes, "white");
        Wine wine2 = new Wine("Chateauneuf du-Pape", provence, "red");
        Wine wine3 = new Wine("Bread and Butter", napa, "white");
        Wine wine4 = new Wine("Chateaux Lafite Rothschild", bordeaux, "red");
        Wine wine5 = new Wine("Chateaux Mot du Jour", bordeaux, "red");
        Wine wine6 = new Wine("Screaming Hawk", fingerLakes, "white");
        Wine wine7 = new Wine("Couronne", provence, "red");
        Wine wine8 = new Wine("Chateaux Garonne", bordeaux, "red");
        Wine wine9 = new Wine("Gironde", bordeaux, "red");
        Wine wine10 = new Wine("Doubting Bird", napa, "white");
        Wine wine11 = new Wine("Vina Vik", chile, "white");
        Wine wine12 = new Wine("Loma Larga", chile, "red");
        Wine wine13 = new Wine("Alsace Vin", alsace, "white");
        Wine wine14 = new Wine("Alsace rouge", alsace, "red");
        Wine wine15 = new Wine("Il Borro Super", tuscany, "red");
        Wine wine16 = new Wine("Mante Antico", tuscany, "white");
        Wine wine17 = new Wine("Bertrand Senecourt", champagne, "white");
        Wine wine18 = new Wine("Wycliff Brut", champagne, "white");
        Wine wine19 = new Wine("Antiquum", oregon, "red");
        Wine wine20 = new Wine("Hyland", oregon, "red");
        Wine wine21 = new Wine("Grand Passione", veneto, "white");
        Wine wine22 = new Wine("Giuseppe Quintarelli", veneto, "red");
